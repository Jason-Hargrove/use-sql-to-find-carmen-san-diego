...
--         population 
-- FROM 
--         country WHERE region = 'Southern Europe'
-- ORDER BY
--         population ASC;

-- =====> Answer to Clue #1: Holy See (Vatican City State). <=====
...
--         *
-- FROM 
--         countrylanguage WHERE language = 'Italian' AND percentage = 100;
-- Returned SMR.
-- SELECT name FROM country WHERE code = 'SMR';

-- =====> Answer to Clue #3: San Marino. <=====
...
--         *
-- FROM 
--         city WHERE countrycode = 'SMR' and name != 'San Marino';
-- =====> Answer to Clue #4: Serravalle. <=====
...
-- SELECT id FROM city WHERE city.population = 91085;
